...
import os
import imageio
"""Tüm haber videoları için sunucu bölümleri kaldırılıp yeni oluşan video VideosWithoutPresenter klasörüne kayıt ediliyor."""
...
def detect(frame):
    ...
    for (x, y, w, h) in faces:
        ...
        name = labels[id_]
        if name == "presenter" and conf >= 65 and conf <= 125:
            return 1
    return 0
...
for i in range(0, video_count):
    ...
    keyframes = []
    keyframes = add_keyframe("keyframes/" + str(i) +  ".avi")
